...
public class Speed extends LightAbility{
	...
	private void setFields() {
		this.speedduration = Spirits.plugin.getConfig().getInt("Spirit.Light.Enchant.SpeedDuration");
	...
	public void progress() {
		...
		Methods.applyPotionPlayer(player, PotionEffectType.SPEED, speedduration);
