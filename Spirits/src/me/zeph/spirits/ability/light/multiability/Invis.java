...
public class Invis extends LightAbility{
	...
	private void setFields() {
		this.invisduration = Spirits.plugin.getConfig().getInt("Spirit.Light.Enchant.InvisDuration");
	...
	public void progress() {
		...
		Methods.applyPotionPlayer(player, PotionEffectType.INVISIBILITY, invisduration);
