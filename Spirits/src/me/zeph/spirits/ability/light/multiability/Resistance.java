...
public class Resistance extends LightAbility{
	...
	private void setFields() {
		this.resistanceduration = Spirits.plugin.getConfig().getInt("Spirit.Light.Enchant.ResistanceDuration");
	...
	public void progress() {
		...
		Methods.applyPotionPlayer(player, PotionEffectType.DAMAGE_RESISTANCE, resistanceduration);
