...
public class Heal extends LightAbility{
	...
	private void setFields() {
		this.healduration = Spirits.plugin.getConfig().getInt("Spirit.Light.Enchant.HealDuration");
	...
	public void progress() {
		...
		Methods.applyPotionPlayer(player, PotionEffectType.REGENERATION, healduration);
